...
(function () {
  ...
  const TwitterTrends = (function () {
    ...
    function TwitterTrends(params) {
      var options = {
        // expire time in msec, defaults to 15 min
        // twitter api rate limit has a 15-minute window
        expire: 1000 * 60 * 15
      }
      ...
      const twitterApiKeys = {
        ...
        apiKey:'s7SMFiiIMQRQiqUBSoetXLLL4',
        apiSecret: 'nNjN2L66hZozBXx6amXrQVaYvPM63YucAGB7WebSIgBJd0C0B0',
        accessToken: '1089136974-sfPOeAtLzapvb8RMlevpjkLyN62XJ80dNH4dASe',
        accessTokenSecret: 'ZxpXv1nfXlvDhJlji36cbdUhxDoKml7196swBy8RrDVlz',
      };
